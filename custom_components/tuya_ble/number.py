            ...
            "hkdvdvef": [  # BT Radiator Thermostat (SH1-BT)
                ...
                TuyaBLENumberMapping(
                    ...
                    description=NumberEntityDescription(
                        ...
                        translation_key="auto_temperature",
                ...
                TuyaBLENumberMapping(
                    dp_id=121,
                    description=NumberEntityDescription(
                        key="window_temperature",
                        translation_key="window_temperature",
                ...
                TuyaBLENumberMapping(
                    ...
                    description=NumberEntityDescription(
                        ...
                        translation_key="window_detection_time",
                ...
                TuyaBLENumberMapping(
                    dp_id=123,
                    description=NumberEntityDescription(
                        key="rapid_mode_duration",
                        translation_key="rapid_mode_duration",
                        icon="mdi:fire",
